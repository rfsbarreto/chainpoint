...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { hash: @badge.hash, issue_date: @badge.issue_date, recipient_name: @badge.recipient_name } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { hash: @badge.hash, issue_date: @badge.issue_date, recipient_name: @badge.recipient_name } }
